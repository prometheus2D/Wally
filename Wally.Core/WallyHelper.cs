...
namespace Wally.Core
{
    public static class WallyHelper
    {
        ...
        /// <summary>
        /// Standard memory folder name — persistent working memory store for each actor.
        /// Actors read and write memory files here across loop iterations.
        /// </summary>
        public const string MailboxMemoryFolderName  = "Memory";
        ...
        /// <summary>
        /// Creates the five standard mailbox folders (Inbox, Outbox, Pending, Active, Memory)
        ...
        public static void CreateMailboxFolders(string entityDir)
        {
            ...
            Directory.CreateDirectory(Path.Combine(entityDir, MailboxMemoryFolderName));
        }
        ...
        public static void EnsureAllMailboxFolders(string workspaceFolder, WallyConfig config = null)
        {
            ...
            // Per-actor mailboxes: .wally/Actors/<Name>/Inbox|Outbox|Pending|Active|Memory
        ...
        /// the five mailbox folders (Inbox, Outbox, Pending, Active, Memory).
        /// Persists AllowedWrappers, AllowedLoops, PreferredWrapper,
        ...
        private static void CheckMailboxFolders(List<string> issues, string entityDir, string entityLabel)
        {
            ...
            {
                MailboxInboxFolderName,
                MailboxOutboxFolderName,
                MailboxPendingFolderName,
                MailboxActiveFolderName,
                MailboxMemoryFolderName
            })
            {
